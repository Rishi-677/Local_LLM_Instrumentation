...
public:
    ...
    void set_attention_sink(AttentionSink& sink) { attn_sink_ = &sink; }
    ...
    uint64_t events_received() const { return received_.load(); }
...
private:
    ...
    static bool parse_float_array(const std::string& s, size_t& i,
    ...
    static bool extract_attention(const std::string& line,
